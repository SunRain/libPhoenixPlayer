...
//OutputThread_old::OutputThread_old(RingBuffer *ring, StateHandler *handle, BaseVisual *v, QObject *parent)
//    : QThread(parent)
//    , m_output(nullptr)
//#if 0
//    , m_device(nullptr)
...
//    connect (m_eq, &EqualizerMgr::changed, this, &OutputThread_old::updateEQ);
//}

//OutputThread_old::~OutputThread_old()
//{

//}

//bool OutputThread_old::initialize(const AudioParameters &para)
//{
...
//bool OutputThread_old::isPaused()
//{
//    return m_pause;
//}

//void OutputThread_old::togglePlayPause()
//{
...
//void OutputThread_old::setMuted(bool muted)
//{
//    m_muted = muted;
//}

//void OutputThread_old::finish()
//{
//    m_finish = true;
//}

//void OutputThread_old::seek(qint64 pos, bool reset)
//{
...
//        if (buffer.samples >0 && buffer.data) {
//            if (m_useEq) {
//                switch(m_audioParameters.format ()) {
//                case AudioParameters::PCM_S16LE:
//                    iir((void*) buffer.data, buffer.samples, m_audioParameters.channels ());
//                    break;
//                case AudioParameters::PCM_S24LE:
//                    iir24((void*) buffer.data, buffer.samples, m_audioParameters.channels ());
//                    break;
//                case AudioParameters::PCM_S32LE:
//                    iir32((void*) buffer.data, buffer.samples, m_audioParameters.channels ());
//                    break;
//                default:
//                    ;
//                }
...
//            if (m_muted)
//                memset(buffer.data, 0, buffer.samples);

//            //change audio to 16bit
//            switch (m_audioParameters.format ()) {
//            case AudioParameters::PCM_S8: {
//                unsigned char *out = new unsigned char[buffer.samples*2];
//                s8_to_s16((qint8 *)buffer.data, (qint16 *) out, buffer.samples);
//                delete [] buffer.data;
//                buffer.data = out;
//                buffer.samples <<= 1;
//                break;
//            }
//            case AudioParameters::PCM_S24LE: {
//                s24_to_s16((qint32 *)buffer.data, (qint16 *)buffer.data, buffer.samples >> 2);
//                buffer.samples >>= 1;
//                break;
//            }
//            case AudioParameters::PCM_S32LE: {
//                s32_to_s16((qint32 *)buffer.data, (qint16 *)buffer.data, buffer.samples >> 2);
//                buffer.samples >>= 1;
//                break;
//            }
//            default:
...
//            //write to output
//            int write = 0;
//            while (buffer.samples > 0 /*&& !m_pause && !m_prev_pause*/) {
//                if (m_skip) {
//                    m_skip = false;
//                    m_output->reset ();
//                    break;
...
//                                              qMin((ulong)m_ring->bufferSize (), buffer.samples));
//#endif
//                write += i;
//                m_totalWritten += i;
//                buffer.samples -= i;
...
//void OutputThread_old::updateEQ()
//{
//    if (m_eq->enabled ()) {
