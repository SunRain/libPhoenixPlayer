#ifndef OUTPUTTHREAD_old_H
#define OUTPUTTHREAD_old_H
...
class RingBuffer;
class StateHandler;
class OutputThread_old : public QThread
{
    Q_OBJECT
public:
    explicit OutputThread_old(RingBuffer *ring, StateHandler *handle, BaseVisual *v = 0, QObject *parent = 0);
    virtual ~OutputThread_old();
